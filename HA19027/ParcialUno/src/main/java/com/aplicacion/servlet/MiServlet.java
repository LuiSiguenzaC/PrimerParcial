    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (btnSumar != null){
                ...
                out.print("Los números primos son "+numerosprimos);
                }
            if (btnRestar != null){
                int resultado = Integer.parseInt(num1) - Integer.parseInt(num2);
                out.println("Bienvenido/a " +Nombre);
                out.print("el resultado de la Resta es: " +resultado);
                out.print("Los números primos son "+numerosprimos);
                }
            if (btnMultiplicar != null){
                int resultado = Integer.parseInt(num1) * Integer.parseInt(num2);
                out.println("Bienvenido/a " +Nombre);
                out.print("el resultado de la Multiplicación es: " +resultado);
                out.print("Los números primos son "+numerosprimos);
                }
            if (btnDividir != null){
                double resultado = Integer.parseInt(num1) / Integer.parseInt(num2);
                out.println("Bienvenido/a " +Nombre);
                out.print("el resultado de la División es: " +resultado);
                out.print("Los números primos son "+numerosprimos);
                }
